...
const Footer = () => {
  return (
    <footer className="relative bg-slate-950 text-slate-300 pt-12 sm:pt-16 pb-8 sm:pb-10 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-3">
              <div className="h-11 w-11 sm:h-12 sm:w-12 flex-shrink-0 rounded-xl bg-white grid place-items-center ring-1 ring-emerald-500/20">
                <img src={LOGO_URL} alt="Zamzam Capital" className="h-full w-full object-contain p-1" />
              </div>
              <div>
                <div className="font-bold text-white text-base sm:text-lg leading-tight">Zamzam Capital</div>
                <div className="text-[11px] font-semibold tracking-[0.18em] text-emerald-400">INDIA</div>
              </div>
            </div>
            <p className="mt-4 sm:mt-5 text-xs sm:text-sm text-slate-400 leading-relaxed max-w-sm">
            ...
            <div className="mt-4 sm:mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-semibold">
          ...
          <div className="lg:col-span-4 lg:col-start-6">
            <h4 className="text-white font-bold text-xs sm:text-sm uppercase tracking-wider mb-3 sm:mb-4 flex items-center gap-2">
              <Building2 className="w-4 h-4 text-emerald-400" /> SEBI Office Address
            </h4>
            <div className="text-xs sm:text-sm text-slate-400 leading-relaxed space-y-1">
              ...
              <div className="flex items-center gap-2 pt-1">
                <Phone className="w-4 h-4 text-emerald-400/80 flex-shrink-0" />
          ...
          <div className="lg:col-span-3 lg:col-start-10">
            ...
            <div className="text-xs sm:text-sm text-slate-400 leading-relaxed space-y-1">
              ...
              <div className="flex items-center gap-2 pt-1">
                <Mail className="w-4 h-4 text-emerald-400/80 flex-shrink-0" />
                <a href="mailto:contact@zamzamcapital.in" className="hover:text-emerald-300 transition-colors break-all">contact@zamzamcapital.in</a>
              </div>
            </div>
          </div>
        </div>
