  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-5 md:px-8 h-16 md:h-20 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-3 group" onClick={(e) => { e.preventDefault(); goTo('#top'); }}>
          <div className="relative h-10 w-10 md:h-11 md:w-11 rounded-xl overflow-hidden bg-white ring-1 ring-emerald-100 shadow-sm group-hover:ring-emerald-300 transition">
            <img src={LOGO_URL} alt="Zamzam Capital" className="h-full w-full object-contain p-1" />
          </div>
          <div className="leading-tight">
            <div className="font-bold text-slate-900 text-base md:text-lg tracking-tight">Zamzam Capital</div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="hidden sm:inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm px-4 md:px-5 py-2.5 rounded-xl shadow-md shadow-emerald-600/20 hover:shadow-emerald-600/40 hover:-translate-y-0.5 transition-all duration-200"
          >
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="md:hidden h-10 w-10 inline-flex items-center justify-center rounded-lg hover:bg-emerald-50 text-slate-700"
      ...
      <div
        className={cn(
          'md:hidden overflow-hidden transition-[max-height,opacity] duration-300 bg-white/95 backdrop-blur-xl border-t border-emerald-100/60',
