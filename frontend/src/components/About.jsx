      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="rounded-3xl bg-white border border-slate-100 p-7 md:p-8 shadow-[0_8px_40px_-20px_rgba(13,148,136,0.25)]">
              ...
              <p className="mt-4 text-slate-700 leading-relaxed text-[15px] md:text-base">
            ...
            <div className="mt-auto pt-6">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-600 p-7 md:p-8 text-white shadow-xl shadow-emerald-600/20">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs uppercase tracking-[0.18em] font-semibold text-emerald-100/90">SEBI Registered</div>
                    <div className="mt-1 text-xl md:text-2xl font-extrabold">Research Analyst</div>
                    <div className="mt-1 text-sm text-emerald-50/95">License No: <span className="font-bold">INH000016199</span></div>
                    <div className="mt-0.5 text-sm text-emerald-50/95">BSE Enlistment No: <span className="font-bold">6158</span></div>
                  </div>
                </div>
              </div>
            </div>
